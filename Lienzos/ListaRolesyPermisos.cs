...
namespace Lienzos
{
    public partial class ListaRolesyPermisos : Form
    {
        int valorcelda = -1;
        public int Usuario { get; set; }
        public int Id_Rol { get; set; }
        public ListaRolesyPermisos()
        {
            InitializeComponent();
        }

        private void ListaRolesyPermisos_Load(object sender, EventArgs e)
        {
            try
            {
            ...
            try
            {
                if (valorcelda != -1)
                {
                    ...
                    if (dr == DialogResult.Yes)
                    {
                        ...
                        valorcelda = -1;
                        ListaRolesyPermisos_Load(null, null);
                    }
                }
                else
                {
